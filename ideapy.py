...
if __name__ == '__main__':
    ...
    #     listen_ips=['0.0.0.0'],
    #     listen_port=8443,
    #     server_name='sng-virtualbox',
    #     server_aliases=['jinja2_app'],
    #     ssl_certificate = './certs/dealsnoffers.net/bundle.crt',
    #     ssl_private_key = './certs/dealsnoffers.net/dealsnoffers.net.key')
    #
    # idea.add_virtual_host(
    #     document_root='/react_js_app/',
    #     listen_ips=['0.0.0.0'],
    #     listen_port=8444,
    #     server_name='sng-virtualbox',
    #     server_aliases=['react_js_app'],
    #     ssl_certificate = './certs/dealsnoffers.net/bundle.crt',
    #     ssl_private_key = './certs/dealsnoffers.net/dealsnoffers.net.key')
    #
    # idea.add_virtual_host(
    #     document_root='/default_page2/',
    #     listen_port=8444,
    ...
    #
    # idea.add_virtual_host(
    #     document_root='/default_page3/sub_page',
    #     listen_port=8445,
    #     server_name='_default_',
    #     ssl_certificate = './certs/dealsnoffers.net/bundle.crt',
    #     ssl_private_key = './certs/dealsnoffers.net/dealsnoffers.net.key')

    # idea.add_virtual_host('/', listen_ips=['127.0.0.1'])
    # idea.remove_virtual_host('localhost', 8080)
    # idea.add_virtual_host('/', listen_ips=['0.0.0.0'], server_aliases=['www'])
